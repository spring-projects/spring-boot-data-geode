...
https://github.com/spring-projects/spring-session-data-geode[_Spring Session for {geode-name}] (SSDG),
and https://github.com/spring-projects/spring-test-data-geode[Spring Test for {geode-name}] (STDG).
