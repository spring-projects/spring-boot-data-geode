...
* _Spring Boot_: **2.2.0 M6** (if `2.2.0 M6` is not available, select the latest, non-BUILD-SNAPSHOT version)
* _Project Metadata_:
** _Group_: **example.app**
** _Artifact_: **crm**
...
version matching "this" version of Spring Boot for Apache Geode (SBDG).  The Spring Boot version may not be `2.2.0.M6`.
...
SBDG minor versions will always match minor versions of Spring Boot.  The SBDG major version will always be one version
behind.  For example, SBDG 1.1 is based on Spring Boot 2.1.  SBDG 1.2 is based on Spring Boot 2.2.  And, SBDG 1.3 will
be based on Spring Boot 2.3.  When Spring Boot reaches 3.0, SBDG will be at 2.0, and so on.
*****
